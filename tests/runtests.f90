...
!   call testequalarray(tline(i,:),unit_y+unit_z,3,"RotAlign, screw", 1.d-15,count_pass,count_fail)
  ...
  if (Nchar>1) then
    call testequal(tline,zeros_threenslip,Nslip,3,"RotAlign, screw", 1.d-13,count_pass,count_fail)
  end if
  do i=1,min(Nslip,12)
...
!   call testequalarray(tline(i,:),unit_y+unit_z,3,"RotAlign, edge", 1.d-15,count_pass,count_fail)
  ...
  call testequal(tline,zeros_threenslip,Nslip,3,"RotAlign, edge", 1.d-13,count_pass,count_fail)
